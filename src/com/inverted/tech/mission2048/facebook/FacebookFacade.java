package com.inverted.tech.mission2048.facebook;
...
import com.inverted.tech.mission2048.facebook.extpack.com.facebook.android.AsyncFacebookRunner;
import com.inverted.tech.mission2048.facebook.extpack.com.facebook.android.DialogError;
import com.inverted.tech.mission2048.facebook.extpack.com.facebook.android.Facebook;
import com.inverted.tech.mission2048.facebook.extpack.com.facebook.android.FacebookError;
...
public class FacebookFacade {
	...
	public void authorize(final AuthListener authListener) {
		facebook.authorize(context, Constants.FACEBOOK_PERMISSIONS,
				Facebook.FORCE_DIALOG_AUTH, new FacebookAuthListener() {
					@Override
					public void onFacebookError(FacebookError e) {
						if (authListener != null)
							authListener.onAuthFail(e.getMessage());
	...
	public void publishMessage(String message, String link, String linkName,
			String linkDescription) {
		publishMessage(message, link, linkName, linkDescription, null);
	}

	public void publishMessage(String message, String link, String linkName,
			String linkDescription, String pictureUrl) {
		publishMessage(message, link, linkName, linkDescription, pictureUrl,
				null);
	}
	...
	public void publishMessage(String message, String link, String linkName,
		...
		if (actions != null) {
			params.putString(RequestParameter.ACTIONS,
					buildActionsString(actions));
		}

		asyncFacebook.request("me/feed", params, "POST",
				new FacebookPostListener(), null);
	}
	...
	private String buildActionsString(Map<String, String> actionsMap) {
		...
		for (Entry<String, String> actionEntry : actionEntries) {
			try {
				...
				actionsObject
						.put(RequestParameter.LINK, actionEntry.getValue());
	...
	public void publishImage(byte[] imageData, String caption) {
		...
		asyncFacebook.request(null, params, "POST", new FacebookPostListener(),
				null);
	}
